...
window.SCRIPT = [
  ...
  { title: "Why not a chatbot", dur: 30, lines: [
    ...
    "(click) Zain already knows your week. You don't have to explain what happened: the habits you ticked, the runs your watch caught, the ones you skipped.",
    ...
    "(click) And the goal is still on track. It will move the week around as much as it needs to. It won't move the race." ] },
  { title: "The whole of you", dur: 20, lines: [
    "A running app plans your runs. Zain plans them around the rest of your life.",
  ...
  { title: "Where this is", dur: 20, lines: [
    ...
    "(click) On the fifteenth of September, Zain intelligence opens to everyone, (click) in English, Arabic and Turkish, right-to-left first.",
    "(click) In December the first plans reach week twelve, and we'll draw that chart again with real people on it." ] },
